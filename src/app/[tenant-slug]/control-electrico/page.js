...
export default function ControlElectricoPage({ params }) {
  ...
  const handleDeleteClick = (id) => {
    ...
    setModalAlert({
      ...
      message: '¿Está seguro de que desea eliminar este control eléctrico? Esta acción no se puede deshacer y borrará permanentemente sus datos y archivos adjuntos.',
  ...
  return (
    <div className="h-screen overflow-hidden bg-syso-bg text-slate-700 flex font-sans">
      ...
      <main className="flex-grow flex flex-col min-w-0 overflow-y-auto">
        ...
        {loading ? (
          <AppLoadingSpinner message="Cargando control de instalaciones eléctricas..." />
        ) : (
                          ...
                          <div className="p-4 bg-slate-50/50 flex-1 flex flex-col justify-center relative">
                            {firmaTipo === 'perfil' ? (
                              ...
                              <div className="bg-white border-2 border-dashed border-slate-200 rounded-xl aspect-[2/1] relative overflow-hidden flex items-center justify-center min-h-[140px] shadow-sm">
                                ...
                                {!isFormDisabled && (hasSignedProf || firmaProfSavedUrl) && (
                                  <button
                                    type="button"
