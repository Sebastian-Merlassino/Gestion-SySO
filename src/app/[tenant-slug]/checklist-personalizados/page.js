        ...
        {loading ? (
          <div className="flex-1 flex flex-col items-center justify-center p-8">
            <div className="text-center space-y-3">
              ...
              <p className="text-xs text-slate-500 font-medium">Cargando listas de verificación...</p>
            </div>
          </div>
        ) : (
                    ...
                    <table className="w-full text-left border-collapse min-w-[850px] text-xs">
                      <thead>
                        <tr className="bg-slate-50 border-b border-slate-200 text-xs font-bold text-slate-400 uppercase tracking-wider select-none">
                          <th className="px-6 py-4 cursor-pointer hover:text-slate-700 select-none sticky top-0 z-10 bg-slate-50 border-b border-slate-200" onClick={() => handleSort('template')}>
                            <div className="flex items-center gap-1.5">
                              Plantilla
                              <AppSortIcon field="template" sortField={sortField} sortOrder={sortOrder} />
                            </div>
                          </th>
                          <th className="px-6 py-4 cursor-pointer hover:text-slate-700 select-none sticky top-0 z-10 bg-slate-50 border-b border-slate-200" onClick={() => handleSort('empresa')}>
                            <div className="flex items-center gap-1.5">
                              Cliente
                          ...
                          return (
                            <tr key={insp.id} className="hover:bg-slate-100 transition-colors cursor-pointer border-b border-slate-100">
                              ...
                              <td className="px-6 py-4 flex items-center justify-end gap-1.5 h-full">
                                 ...
                                 {canEditar && (
                                   <AppTooltip content="Editar inspección">
                                     <AppButton
                                       variant="edit-table"
                                       size="icon"
                                 ...
                                 {canEliminar && (
                                   <AppTooltip content="Eliminar inspección">
                                     <AppButton
                      ...
                      <tbody className="divide-y divide-slate-100 text-slate-700">
                        {templates
                          ...
                          <tr key={tmpl.id} className="hover:bg-slate-100 transition-colors cursor-pointer border-b border-slate-100">
                            ...
                            <td className="px-6 py-4 flex items-center justify-end gap-1.5 h-full">
                               {canEditar && (
                                 <AppTooltip content="Editar plantilla">
                                   <AppButton
                                     variant="edit-table"
                                     size="icon"
                               ...
                               {canEliminar && (
                                 <AppTooltip content="Eliminar plantilla">
                                   <AppButton
                                     variant="delete-table"
                                     size="icon"
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            {activeTemplate.bloque_firmas.responsable_higiene_seguridad && (
                              <div className="space-y-2 flex flex-col">
                                <div className="flex flex-row justify-between items-center min-h-[24px]">
                                  <label className="text-xs font-bold text-slate-600">Firma del Profesional Técnico</label>
                                </div>
                                
                                <div className="border border-slate-200 rounded-2xl overflow-hidden bg-white shadow-sm flex flex-col h-[220px]">
                                  ...
                                  <div className="p-4 bg-slate-50/50 flex-1 flex flex-col justify-center relative">
                                    {firmaTipo === 'perfil' ? (
                                      <div className="border-2 border-dashed border-slate-200 bg-white rounded-xl flex-1 w-full relative overflow-hidden flex items-center justify-center p-3 text-center shadow-sm">
                                      ...
                                      <div className="bg-white border-2 border-dashed border-slate-200 rounded-xl flex-1 w-full relative overflow-hidden flex items-center justify-center shadow-sm">
