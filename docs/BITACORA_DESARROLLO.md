...
- **Incorporación de Hojas Informativas de Acústica en el PDF de Ruido (Dec. 351/79 - Anexo V):**
  ...
  - Se configuró la alineación de texto justificado (`{ align: 'justify', maxWidth: 180 }`) y un espaciado vertical dinámico uniforme y homogéneo entre todos los párrafos (`normal`, `formula` y `legend`) en las hojas informativas del PDF.
