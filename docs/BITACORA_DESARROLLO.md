...
- **Estructura y Generación de PDF del Módulo Ruido (`src/app/[tenant-slug]/protocolos/ruido/`):**
  ...
  - Se creó el catálogo normativo `tablasAnexoV.js` y el componente de la ventana emergente `Tabla1RuidoModal.js`, agregando el botón **"Ver Tabla 1"** junto al título del desglose de fracciones para consultar interactivamente la **Tabla 1 — Valores límite para ruido** (24 hs a 80 dBA hasta 0,11 seg a 139 dBA).
