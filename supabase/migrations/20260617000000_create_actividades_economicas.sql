-- Migration to create public.actividades_economicas table and populate it
...
('14211', 'Cría de ganado equino, excepto la realizada en haras (Incluye equinos de trabajo, asnos, mulas, burdéganos)'),
('11331', 'Cultivo de hortalizas de hoja y de otras hortalizas frescas (Incluye acelga, apio, coles, espinaca, lechuga, perejil, radicheta, repollo, etc.)'),
('14410', 'Cría de ganado ovino -excepto en cabañas y para la  producción de lana y leche-'),
('11211', 'Cultivo de soja'),
('17010', 'Caza y repoblación  de animales de caza (Incluye la caza de animales para obtener carne, pieles y cueros y la captura de animales vivos para zoológicos, animales de compañía, para investigación, etc.)'),
...
('14221', 'Cría de ganado equino realizada en haras (Incluye la producción de semen)'),
...
('14121', 'Cría de ganado bovino realizada en cabañas (Incluye: ganado bubalino y la producción de semen)'),
...
('14990', 'Cría de animales y obtención de productos de origen animal, n.c.p. (Incluye ciervo, gato, gusano de seda, lombriz, pájaro, perro, rana, animales para experimentación, caracoles vivos, frescos, congelados y secos -excepto marinos-, cera de insectos excepto la de abeja, etc.)'),
('12590', 'Cultivo de plantas sacaríferas n.c.p. (Incluye remolacha azucarera, etc.)'),
('14510', 'Cría de ganado porcino, excepto la realizada en cabañas'),
('14440', 'Cría de ganado caprino realizada en cabañas'),
('14930', 'Cría de animales pelíferos, pilíferos y plumíferos, excepto de las especies ganaderas (Incluye cría de visón, nutria, chinchilla, reptiles, etc.)'),
...
('11990', 'Cultivos temporales ncp'),
('12311', 'Cultivo de manzana y pera'),
('12510', 'Cultivo de caña de azúcar'),
('16130', 'Servicios de contratistas de mano de obra agrícola (Incluye la poda de árboles, transplante, cosecha manual de citrus, algodón, etc.)'),
('11341', 'Cultivo de legumbres frescas (Incluye arveja, chaucha, haba, lupino, etc.)'),
...
('12410', 'Cultivo de frutas tropicales y subtropicales (Incluye banana, ananá, mamón, palta, etc.)'),
('11321', 'Cultivo de tomate'),
('11112', 'Cultivo de trigo'),
('16190', 'Servicios de apoyo agrícolas n.c.p (Incluye  explotación de sistemas de riego, injertos de plantas, construcción y plantación de almácigos, alquiler de colmenas, etc.), (No incluye mantenimiento de jardines, parques y cementerios: actividad 813000, planificación y diseño paisajista: actividad 711009)'),
('16119', 'Servicios de maquinaria agrícola n.c.p., excepto los de cosecha mecánica (Incluye clasificado y/o tamañado, rastrillado, roturación de terreno, etc.)'),
('11119', 'Cultivo de cereales n.c.p., excepto los de uso forrajero (Incluye alforfón, cebada cervecera, etc.)'),
...
('16120', 'Servicios de cosecha mecánica (Incluye la cosecha mecánica de granos, caña de azúcar, algodón, forrajes, el enfardado, enrollado, etc.)'),
('12490', 'Cultivo de frutas n.c.p. (Incluye kiwi, arándanos, mora, grosella, etc.)'),
...
('16140', 'Servicios de post cosecha (Incluye servicios de lavado de papas,  acondicionamiento, limpieza, etc, de granos antes de ir a los mercados primarios), (Excluye los servicios de procesamiento de semillas para su siembra)'),
...
('16220', 'Servicios de contratistas de mano de obra pecuaria (Incluye arreo, castración de aves, pasturaje,  etc.)'),
('14113', 'Cría de ganado bovino, excepto la realizada en cabañas y para la producción de leche (Incluye: ganado bubalino)'),
('11509', 'Cultivo de plantas para la obtención de fibras n.c.p. (Incluye abacá, cáñamo, formio, lino textil, maíz de Guinea, ramio, yute, etc.)'),
...
('12600', 'Cultivo de frutos oleaginosos (Incluye el cultivo de olivo, coco, palma, etc.)'),
('11299', 'Cultivo de oleaginosas n.c.p. excepto soja y girasol (Incluye los cultivos de oleaginosas para aceites comestibles y/o uso industrial: cártamo, colza, jojoba, lino oleaginoso, maní, ricino, sésamo, tung, etc.)'),
('12319', 'Cultivo de frutas de pepita n.c.p. (Incluye membrillo, níspero, etc.)'),
('11342', 'Cultivo de legumbres secas (Incluye garbanzo, lenteja, poroto, etc.)'),
('14300', 'Cría de camélidos (Incluye alpaca, guanaco, llama, vicuña)'),
('13011', 'Producción de semillas híbridas de cereales y oleaginosas'),
('11121', 'Cultivo de maíz'),
('11329', 'Cultivo de bulbos, brotes, raíces y hortalizas de fruto n.c.p. (Incluye ají, ajo, alcaparra, berenjena, cebolla, calabaza, espárrago, frutilla, melón, pepino, pimiento, sandía, zanahoria, zapallo, zapallito, etc.)'),
...
('12200', 'Cultivo de frutas cítricas (Incluye bergamota, lima, limón, mandarina, naranja, pomelo, kinoto, etc.)'),
('24020', 'Servicios forestales excepto los servicios para la extracción de madera (Incluye protección contra incendios, evaluación de masas forestales en pie, estimación del valor de la madera, etc.)'),
('21020', 'Repoblación y conservación de bosques nativos y zonas forestadas'),
('22020', 'Extracción de productos forestales de bosques nativos (Incluye tala de árboles, desbaste de troncos y producción de madera en bruto, leña, postes, la extracción de rodrigones, varas, varillas y la recolección de  gomas naturales, líquenes, musgos, resinas y de rosa mosqueta,etc)'),
('22010', 'Extracción de productos forestales de bosques cultivados (Incluye tala de árboles, desbaste de troncos y producción de madera en bruto, leña, postes)'),
('24010', 'Servicios forestales para la extracción de madera (Incluye tala de árboles, acarreo y transporte en el interior del bosque, servicios realizados por terceros, etc.)'),
('21030', 'Explotación de viveros forestales (Incluye propagación de especies forestales)'),
('21010', 'Plantación de bosques'),
('31130', 'Recolección de organismos marinos excepto peces, crustáceos y moluscos (Incluye la recolección de algas marinas)'),
...
('51000', 'Extracción y aglomeración de carbón (Incluye la producción de hulla no aglomerada, antracita, carbón bituminoso no aglomerado, ovoides y combustibles sólidos análogos a base de hulla, etc.)'),
...
('71000', 'Extracción de minerales de hierro (Incluye hematitas, limonitas, magnetitas, siderita, etc.)'),
('72910', 'Extracción de metales preciosos'),
('72990', 'Extracción de minerales metalíferos no ferrosos n.c.p., excepto minerales de uranio y torio (Incluye aluminio, cobre, estaño, manganeso, níquel, plomo, volframio, antimonio, bismuto, cinc, molibdeno, titanio, circonio, niobio, tántalo, vanadio, cromo, cobalto)'),
('81100', 'Extracción de rocas ornamentales (Incluye areniscas, cuarcita, dolomita, granito, mármol, piedra laja, pizarra, serpentina, etc.)'),
('89200', 'Extracción y aglomeración de turba (Incluye la producción de turba utilizada como corrector de suelos)'),
...
('81300', 'Extracción de arenas, canto rodado y triturados pétreos (Incluye arena para construcción, arena silícea, otras arenas naturales, canto rodado, dolomita triturada, salto triturado, piedra partida  y  otros triturados pétreos, etc.)'),
('89110', 'Extracción de minerales para la fabricación de abonos excepto turba (Incluye guano, silvita, silvinita y otras sales de potasio naturales, etc.)'),
('89900', 'Explotación de minas y canteras n.c.p. (Incluye amianto, cuarzo, diatomita, piedra pómez, ágata, agua marina, amatista, cristal de roca, rodocrosita, topacio, corindón, feldespato, mica, zeolita, perlita, granulado volcánico, puzolana, toba, talco, vermiculita, tosca, grafito, etc.)'),
('81200', 'Extracción de piedra caliza y yeso (Incluye caliza, castina, conchilla, riolita, yeso natural, anhidrita, etc.)'),
('81400', 'Extracción de arcilla y caolín (Incluye andalucita, arcillas, bentonita, caolín, pirofilita, silimanita, mullita, tierra de chamota o de dinas, etc.)'),
...
('105090', 'Elaboración de productos lácteos n.c.p. (Incluye la producción de caseínas, manteca, postres, etc., cuando no son obtenidos e forma integrada con la producción de leche)'),
...
('351130', 'Generación de energía hidráulica (Incluye la producción de energía eléctrica mediante centrales de bombeo)'),
('352010', 'Fabricación de gas y procesamiento de gas natural'),
('351201', 'Transporte de energía eléctrica'),
('351190', 'Generación de energía n.c.p. (Incluye la producción de energía eléctrica mediante fuentes de energía solar, biomasa, eólica, geotérmica, mareomotriz, etc.)'),
('351320', 'Distribución de energía eléctrica'),
('353001', 'Suministro de vapor y aire acondicionado'),
('351120', 'Generación de energía térmica nuclear (Incluye la producción de energía eléctrica mediante combustible nuclear)'),
('352020', 'Distribución de combustibles gaseosos por tuberías (No incluye el transporte por gasoductos)'),
...
('410011', 'Construcción, reforma y reparación de edificios residenciales (Incluye la construcción, reforma y reparación  de viviendas unifamiliares y multifamiliares, bungaloes, cabañas, casas de campo, departamentos, albergues para ancianos, niños, estudiantes, etc.)'),
('421000', 'Construcción, reforma y reparación de obras de infraestructura para el transporte (Incluye la construcción, reforma y reparación de calles, autopistas, carreteras, puentes, túneles, vías férreas y pistas de aterrizaje, la señalización mediante pintura, etc.)'),
('429010', 'Construcción, reforma y reparación de obras hidráulicas (Incluye obras fluviales y canales, acueductos, diques, etc.)'),
...
('429090', 'Construcción de obras de ingeniería civil n.c.p. (Incluye los trabajos generales de construcción para la minería y la industria,  de centrales eléctricas y nucleares, excavaciones de sepulturas, etc.)'),
('432110', 'Instalación de sistemas de iluminación, control y señalización eléctrica para el transporte'),
('433010', 'Instalaciones de carpintería, herrería de obra y artística (Incluye instalación de puertas y ventanas, carpintería metálica y no metálica, etc.)'),
('433090', 'Terminación de edificios n.c.p. (Incluye trabajos de ornamentación, limpieza exterior de edificios recién construídos, etc.)'),
('439990', 'Actividades especializadas de construcción n.c.p. (Incluye el alquiler, montaje y desmantelamiento de andamios,  la construcción de chimeneas y hornos industriales, el acorazamiento de cajas fuertes y cámaras frigoríficas, el armado e instalación de compuertas para diques, etc.)'),
...
('432200', 'Instalaciones de gas, agua, sanitarios y de climatización, con sus artefactos conexos (Incluye la instalación de compactadores, calderas, sistemas de calefacción central, etc.)'),
('432190', 'Instalación, ejecución y mantenimiento de instalaciones eléctricas, electromecánicas y electrónicas n.c.p. (Incluye la instalación de antenas, pararrayos, sistemas de alarmas contra incendios y robos, sistemas de telecomunicación, etc.)'),
('433020', 'Terminación y revestimiento de paredes y pisos (Incluye yesería, salpicré, el pulido de pisos y la colocación de revestimientos de cerámicas, de piedra tallada, de suelos flexibles, parqué, baldosas, empapelados, etc.)'),
...
('431100', 'Demolición y voladura de edificios y de sus partes (Incluye los trabajos de limpieza de escombros asociada a la demolición, los derribos y demolición de edificios y obras de ingeniería civil,.los trabajos de voladura y remoción de rocas)'),
...
('432990', 'Instalaciones para edificios y obras de ingeniería civil n.c.p. (Incluye instalación de puertas automáticas o giratorias)'),
('433030', 'Colocación de cristales en obra (Incluye la instalación y revestimiento de vidrio, espejos y otros artículos de vidrio, etc.)'),
('452210', 'Reparación de cámaras y cubiertas (Incluye reparación de llantas)'),
...
('451190', 'Venta de vehículos automotores nuevos n.c.p. (Incluye casas rodantes, trailers, camiones, remolques, ambulancias, ómnibus, microbuses y similares, cabezas tractoras, etc.)'),
('454020', 'Mantenimiento y reparación de motocicletas'),
('453292', 'Venta al por menor de partes, piezas y accesorios usados n.c.p.'),
('451290', 'Venta de vehículos automotores usados n.c.p. (Incluye, casas rodantes, trailers, camiones, remolques, ambulancias, ómnibus, microbuses y similares, cabezas tractoras, etc.)'),
('452800', 'Mantenimiento y reparación de frenos y embragues'),
('452910', 'Instalación y reparación de equipos de GNC'),
('452990', 'Mantenimiento y reparación del motor n.c.p., mecánica integral (Incluye auxilio y servicios de grúa para automotores)'),
('451210', 'Venta de autos, camionetas y utilitarios, usados (Incluye taxis, jeeps, 4x4 y vehículos similares)'),
('451110', 'Venta de autos, camionetas y utilitarios nuevos (Incluye taxis, jeeps, 4x4 y vehículos similares)'),
...
('452300', 'Instalación y reparación de parabrisas, lunetas y ventanillas, cerraduras no eléctricas y grabado de cristales (Incluye instalación y reparación de aletas, burletes y colisas)'),
...
('464940', 'Venta al por mayor de bicicletas y rodados similares (Incluye cochecitos y sillas de paseo para bebés, andadores, triciclos, etc.)'),
...
('461021', 'Venta al por mayor en comisión o consignación de ganado bovino en pie (Incluye consignatarios de hacienda y ferieros)'),
...
('461013', 'Venta al por mayor en comisión o consignación de frutas (Incluye acopiadores y receptoras)'),
('463151', 'Venta al por mayor de pan, productos de confitería y pastas frescas'),
('465350', 'Venta al por mayor de máquinas, equipos e implementos de uso médico y paramédico (Incluye venta de equipos de diagnóstico y tratamiento, camillas, cajas de cirugía, jeringas y otros implementos de material descartable, etc.)'),
('464310', 'Venta al por mayor de productos farmacéuticos (Incluye venta de medicamentos y kits de diagnóstico como test de embarazo, hemoglucotest, vacunas, etc.)'),
...
('466320', 'Venta al por mayor de productos de madera excepto muebles (Incluye placas, varillas, parqué, machimbre, etc.)'),
...
('464112', 'Venta al por mayor de artículos de mercería (Incluye la venta de puntillas, galones, hombreras, agujas, botones, etc.)'),
...
('464950', 'Venta al por mayor de artículos de esparcimiento y deportes (Incluye embarcaciones deportivas, armas y municiones, equipos de pesca, piletas de natación de lona o plástico, etc.)'),
('464142', 'Venta al por mayor de suelas y afines (Incluye talabarterías, artículos regionales de cuero, almacenes de suelas, etc.)'),
('464212', 'Venta al por mayor de diarios y revistas'),
('465390', 'Venta al por mayor de máquinas, equipos e implementos de uso especial n.c.p.  (Incluye motoniveladoras, excavadoras, palas mecánicas, perforadoras-percutoras, etc.)'),
('462110', 'Acopio de algodón'),
('464910', 'Venta al por mayor de CD''s y DVD''s de audio y video grabados.'),
('462190', 'Venta al por mayor de materias primas agrícolas y de la silvicultura n.c.p. (Incluye el acopio y venta al por mayor de materiles, desperdicios, subproductos agrícola usados como alimentos para animales)'),
('465320', 'Venta al por mayor de máquinas, equipos e implementos de uso en la elaboración de alimentos, bebidas y tabaco (Incluye máquinas para moler, picar y cocer alimentos, fabricadora de pastas, bateas, enfriadoras y envasadoras de bebidas, etc.)'),
('465340', 'Venta al por mayor de máquinas, equipos e implementos de uso en imprentas, artes gráficas y actividades conexas (Incluye venta de máquinas fotocopiadoras - excepto las de uso personal-, copiadoras de planos, máquinas para imprimir, guillotinar, troquelar, encuadernar, etc.)'),
('465360', 'Venta al por mayor de máquinas, equipos e implementos de uso en la industria del plástico y del caucho (Incluye sopladora de envases, laminadora de plásticos, máquinas extrusoras y moldeadoras, etc.)'),
('465930', 'Venta al por mayor de equipo profesional y científico e instrumentos de medida y de control n.c.p.'),
('464410', 'Venta al por mayor de artículos de óptica y de fotografía (Incluye venta de lentes de contacto, líquidos oftalmológicos, armazones, cristales ópticos, películas fotográficas, cámaras y accesorios para fotografía, etc.)'),
...
('466330', 'Venta al por mayor de artículos de ferretería y materiales eléctricos (Incluye la venta  de clavos, cerraduras, cable coaxil. etc)'),
...
('466399', 'Venta al por mayor de artículos para la construcción n.c.p. (No incluye artículos y materiales de demolición: 466990 )'),
...
('464330', 'Venta al por mayor de instrumental médico y odontológico y artículos ortopédicos (Incluye venta de vaporizadores, nebulizadores, masajeadores, termómetros, prótesis, muletas, plantillas, calzado ortopédico y otros artículos similares de uso personal o doméstico)'),
...
('464320', 'Venta al por mayor de productos cosméticos, de tocador y de perfumería (Incluye venta de artículos para peluquería excepto equipamiento)'),
('464999', 'Venta al por mayor de artículos de uso doméstico o personal n.c.p (Incluye artículos de platería excepto los incluidos en talabartería, cuadros y marcos que no sean obra de arte o de colección, sahumerios y artículos de santería, parrillas y hogares, etc.)'),
...
('465310', 'Venta al por mayor de máquinas, equipos e implementos de uso en los sectores agropecuario, jardinería, silvicultura, pesca y caza (Incluye venta de tractores, cosechadoras, enfardadoras, remolques de carga y descarga automática, motosierras, cortadoras de césped autopropulsadas, etc.)'),
('466310', 'Venta al por mayor de aberturas (Incluye puertas, ventanas, cortinas de enrollar, madera, aluminio, puertas corredizas, frentes de placard, etc.)'),
...
('464930', 'Venta al por mayor de juguetes (Incluye artículos de cotillón)'),
...
('464130', 'Venta al por mayor de calzado excepto el ortopédico (Incluye venta de calzado de cuero, tela, plástico, goma, etc.)'),
...
('466940', 'Venta al por mayor de productos intermedios n.c.p., desperdicios y desechos metálicos (Incluye chatarra, viruta de metales diversos, etc.)'),
...
('477110', 'Venta al por menor de ropa interior, medias, prendas para dormir y para la playa (Incluye corsetería, lencería, camisetas, medias excepto ortopédicas, pijamas, camisones y saltos de cama, salidas de baño, trajes de baño, etc.)'),
...
('477490', 'Venta al por menor de artículos nuevos n.c.p. (Incluye la venta realizada en casas de regalos, de artesanías, pelucas,  de artículos religiosos -santerías-, recarga de matafuegos,  etc.)'),
('475420', 'Venta al por menor de colchones y somieres'),
('472111', 'Venta al por menor de productos lácteos'),
('476310', 'Venta al por menor de equipos  y artículos deportivos (Incluye la venta y reparación  de bicicletas, la venta  de aparatos de gimnasia y de equipos de camping, etc.)'),
...
('475120', 'Venta al por menor de confecciones para el hogar (Incluye la venta al por menor de sábanas, toallas, mantelería, cortinas confeccionadas, colchas, cubrecamas, etc.)'),
('477460', 'Venta al por menor de fuel oil, gas en garrafas, carbón y leña (No incluye las estaciones de servicios que se clasifican en 473000)'),
('477310', 'Venta al por menor de productos farmacéuticos y de herboristería'),
('474020', 'Venta al por menor de aparatos de telefonía y comunicación (Incluye teléfonos, celulares, fax, etc)'),
('477330', 'Venta al por menor de instrumental médico y odontológico y artículos ortopédicos (Incluye venta de vaporizadores, nebulizadores, masajeadores, termómetros, prótesis, muletas, plantillas, calzado ortopédico y otros artículos similares de uso personal o doméstico)'),
('477470', 'Venta al por menor de productos veterinarios, animales domésticos y alimento balanceado para mascotas'),
('477220', 'Venta al por menor de calzado, excepto el ortopédico y el deportivo (No incluye almacenes de suelas 464142)'),
('472112', 'Venta al por menor de fiambres y embutidos'),
('475210', 'Venta al por menor de aberturas (Incluye puertas, ventanas, cortinas de enrollar de PVC, madera, aluminio, puertas corredizas, frentes de placards, etc.)'),
('477210', 'Venta al por menor de artículos de talabartería y artículos regionales (Incluye venta de artículos regionales de cuero, plata, alpaca y similares)'),
...
('479900', 'Venta al por menor no realizada en establecimientos  n.c.p. (Incluye venta mediante máquinas expendedoras, vendedores ambulantes y vendedores a domicilio)'),
...
('473000', 'Venta al por menor de combustible para vehículos automotores y motocicletas (Incluye la venta al por menor de productos lubricantes y refrigerantes)'),
...
('476200', 'Venta al por menor de CD''s y DVD''s de audio y video grabados (Incluye CD''s y DVD''s vírgenes)'),
...
('475490', 'Venta al por menor de artículos para el hogar n.c.p. (Incluye perchas, marcos, cuadros, etc.)'),
...
('475190', 'Venta al por menor de artículos textiles n.c.p. excepto prendas de vestir (Incluye la venta al por menor de tapices, alfombras,  etc.)'),
('475110', 'Venta al por menor de hilados, tejidos y artículos de mercería (Incluye mercerías, sederías, comercios de venta de lanas y otros hilados, etc.)'),
...
('477840', 'Venta al por menor de oro, monedas, sellos y similares (Incluye la  venta de monedas de colección, estampillas, etc.)'),
...
('493200', 'Servicio de transporte por gasoductos (Incluye estaciones de bombeo y compresión)'),
('492130', 'Servicio de transporte escolar (Incluye el servicio de transporte para colonias de vacaciones y clubes)'),
('492221', 'Servicio de transporte automotor de cereales'),
('492280', 'Servicio de transporte automotor urbano de carga n.c.p. (Incluye el transporte realizado por fleteros y distribuidores dentro del égido urbano)'),
('492229', 'Servicio de transporte automotor de mercaderías a granel n.c.p.'),
('491110', 'Servicio de transporte ferroviario urbano y suburbano de pasajeros (Incluye el servicio de subterráneo y de premetro)'),
('491200', 'Servicio de transporte ferroviario de cargas'),
('492150', 'Servicio de transporte automotor interurbano regular de pasajeros, E1203excepto transporte internacional (Incluye los llamados servicios de larga distancia)'),
...
('492120', 'Servicios de transporte automotor de pasajeros mediante taxis y remises, alquiler de autos con chofer (Incluye los radiotaxis)'),
...
('492290', 'Servicio de transporte automotor de cargas n.c.p. (Incluye  servicios de transporte de carga refrigerada y transporte pesado)'),
('493110', 'Servicio de transporte por oleoductos (Incluye estaciones de bombeo y compresión)'),
...
('492210', 'Servicios de mudanza (Incluye servicios de guardamuebles)'),
...
('524230', 'Servicios para la navegación (Incluye servicios de practicaje y pilotaje, atraque y salvamento)'),
('524290', 'Servicios complementarios para el transporte marítimo n.c.p. (Incluye explotación de servicios de terminales como puertos y muelles)'),
...
('524330', 'Servicios para la aeronavegación (Incluye remolque de aeronaves y actividades de control de tráfico aéreo, etc.)'),
...
('524190', 'Servicios complementarios para el transporte terrestre n.c.p. (Incluye servicios de mantenimiento de material ferroviario)'),
...
('523090', 'Servicios de gestión y logística para el transporte de mercaderías n.c.p. (Incluye las actividades de empresas empaquetadoras para comercio exterior, alquiler de contenedores, etc.)'),
...
('524390', 'Servicios complementarios para el transporte aéreo n.c.p. (Incluye servicios de prevención y extinción de incendios)'),
...
('530010', 'Servicio de correo postal (Incluye las actividades de correo postal sujetas a la obligación de servicio universal)'),
('530090', 'Servicios de mensajerías (Incluye servicios puerta a puerta de correo y mensajería, comisionistas de encomiendas, transporte de documentos  realizados por empresas no sujetas a la obligación de servicio universal)'),
...
('562091', 'Servicios de cantinas con atención exclusiva  a los empleados o estudiantes dentro de empresas o establecimientos educativos (Incluye cantinas deportivas)'),
('561014', 'Servicios de expendio de bebidas en bares (Incluye: bares, cervecerías, pubs, cafeterías)'),
('561020', 'Servicios de preparación de comidas para llevar (Incluye rotiserías, casas de empanadas, pizzerías sin consumo en el local)'),
...
('619000', 'Servicios de telecomunicaciones n.c.p. (Incluye el servicio de pagers)'),
...
('712000', 'Ensayos y análisis técnicos (Incluye inspección técnica de vehículos, laboratorios de control de calidad, servicios de peritos calígrafos, servicios de bromatología)'),
...
('741000', 'Servicios de diseño especializado (Incluye diseño de indumentaria, diseño gráfico, actividades de decoradores, etc.)'),
...
('771190', 'Alquiler de vehículos automotores n.c.p., sin conductor ni operarios (Incluye: camiones, remolques, etc.)'),
...
('772010', 'Alquiler de videos y video juegos (Incluye la actividad de los videoclubes)'),
('772091', 'Alquiler de prendas de vestir'),
('772099', 'Alquiler de efectos personales y enseres domésticos n.c.p. (Incluye alquiler de artículos deportivos)'),
('773090', 'Alquiler de maquinaria y equipo n.c.p., sin personal'),
('771290', 'Alquiler de equipo de transporte n.c.p. sin conductor ni operarios (Incluye: equipo ferroviario, motocicletas)'),
('773030', 'Alquiler de maquinaria y equipo de construcción e ingeniería civil, sin operarios (Incluye el alquiler de andamios sin montaje ni desmantelamiento)'),
('774000', 'Arrendamiento y gestión de bienes intangibles no financieros'),
('771110', 'Alquiler de automóviles sin conductor'),
('780000', 'Obtención y dotación de personal (Incluye las actividades vinculadas con la búsqueda, selección y colocación de personal, la actividad de casting de actores, etc.)'),
...
('841200', 'Servicios para la regulación de las actividades sanitarias, educativas, culturales, y restantes servicios sociales, excepto seguridad social obligatoria (Incluye  la gestión administrativa de programas destinados a mejorar el bienestar de los ciudadanos)'),
('843000', 'Servicios de la seguridad social obligatoria, excepto obras sociales (Incluye PAMI y ANSES)'),
...
('841900', 'Servicios auxiliares para los servicios generales de la Administración Pública (Incluye las actividades de servicios generales y de personal, la administración, dirección y apoyo de servicios generales, compras y suministros, etc. )'),
('842500', 'Servicios de protección civil'),
('841300', 'Servicios para la regulación de la actividad económica (Incluye la administración pública y la regulación de varios sectores económicos, la gestión administrativa de actividades de carácter laboral, la aplicación de políticas de desarrollo regional)'),
...
('854990', 'Servicios de enseñanza n.c.p. (Incluye instrucción impartida mediante programas de radio, televisión, correspondencia y otros medios de comunicación, escuelas de manejo, actividades de enseñanza a domicilio y/o particulares, etc.)'),
...
('863110', 'Servicios de prácticas de diagnóstico en laboratorios (Incluye análisis clínicos, bioquímica, anatomía patológica, laboratorio hematológico, etc.)'),
('861010', 'Servicios de internación excepto instituciones relacionadas con la salud mental'),
('863120', 'Servicios de prácticas de diagnóstico por imágenes (Incluye radiología, ecografía, resonancia magnética, etc.)'),
('863200', 'Servicios de tratamiento (Incluye hemodiálisis, cobaltoterapia, etc)'),
...
('869010', 'Servicios de rehabilitación física (Incluye actividades de profesionales excepto médicos: kinesiólogos, fisiatras, etc.)'),
...
('931042', 'Servicios prestados por profesionales y técnicos para la realización de prácticas deportivas (Incluye la actividad realizada por entrenadores, instructores, jueces árbitros, cronometradores, etc.)'),
...
('931050', 'Servicios de acondicionamiento físico (Incluye gimnasios de musculación, pilates, yoga, personal trainner, etc.)'),
('931010', 'Servicios de organización, dirección y gestión de prácticas deportivas en clubes (Incluye clubes de fútbol, golf, tiro, boxeo, etc.)'),
...
('952100', 'Reparación de artículos eléctricos y electrónicos de uso doméstico (Incluye  TV, radios, reproductores cd''s y dvd''s, cámaras de video de uso familiar, heladeras, lavarropas, secarropas, aire acondicionado de menos de 6000 frigorías)'),
...
('952300', 'Reparación de tapizados y muebles (Incluye la restauración de muebles)'),
('951200', 'Reparación y mantenimiento de equipos de telefonía y de comunicación'),
('952990', 'Reparación de efectos personales y enseres domésticos n.c.p. (Incluye la actividad de arreglos de prendas realizadas por modistas), (No incluye la actividad de sastres y modistas que confeccionan prendas: grupo 141)'),
